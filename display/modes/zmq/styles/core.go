...
type Params struct {
	BuildFn func(content.ZMQData, content.Policy, style.StyleContext, def) style.ViewData
}
...
var _ style.Style[content.ZMQData, content.Policy] = def{}
...
func (d def) Build(data content.ZMQData, pol content.Policy, ctx style.StyleContext) style.ViewData {
	if d.p.BuildFn != nil {
