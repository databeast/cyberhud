...
type ColorFastStyle struct{ Width, Height int }
...
func (s ColorFastStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.ColorFast, MinRows: 0, MinCharsPerLine: 0}
}
...
func (s ColorFastStyle) Build(snapshot source.Data, pol source.Policy, ctx style.StyleContext) style.ViewData {
	...
	return style.ViewData{Static: false, Sprites: snapshot.Sprites}
}

// MonoFastStyle targets monochrome OLED panels.
type MonoFastStyle struct{ Width, Height int }
...
func (s MonoFastStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.MonoFast, MinRows: 0, MinCharsPerLine: 0}
}
...
type MonoSlowStyle struct{ Width, Height int }
...
func (s MonoSlowStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.MonoSlow, MinRows: 0, MinCharsPerLine: 0}
}
...
// GrayscaleFastStyle targets grayscale fast panels.
type GrayscaleFastStyle struct{ Width, Height int }
...
func (s GrayscaleFastStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.GrayscaleFast, MinRows: 0, MinCharsPerLine: 0}
}
...
type GrayscaleSlowStyle struct{ Width, Height int }
...
func (s GrayscaleSlowStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.GrayscaleSlow, MinRows: 0, MinCharsPerLine: 0}
}
...
type ColorSlowStyle struct{ Width, Height int }
...
func (s ColorSlowStyle) Requirements() style.SurfaceRequirements {
	return style.SurfaceRequirements{MinWidth: s.Width, MinHeight: s.Height, Capability: style.ColorSlow, MinRows: 0, MinCharsPerLine: 0}
}
