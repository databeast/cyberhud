...
func TestTestIconsPNGSnapshots(t *testing.T) {
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			pngPath := testsnapshot.RenderSnapshot(t,
				testsnapshot.WithMode("testicons"),
	...
	if err := testsnapshot.WriteGalleryFragmentFromPaths(snapshotOutputDir, "testicons", pngPaths); err != nil {
