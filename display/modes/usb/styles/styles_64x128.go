...
// USB style declarations for 64×128 panels (portrait, w≥64 and w<128).
...
var GrayscaleFast64x128MinimalStyle = def{
	name: "grayscale-fast-64x128-minimal",
	reqs: style.SurfaceRequirements{MinWidth: 64, MinHeight: 128, Capability: style.GrayscaleFast},
	p:    Params{BuildFn: buildMinimal},
}
...
var ColorFast64x128MinimalStyle = def{
	name: "color-fast-64x128-minimal",
	reqs: style.SurfaceRequirements{MinWidth: 64, MinHeight: 128, Capability: style.ColorFast},
	p:    Params{BuildFn: buildMinimal},
}
