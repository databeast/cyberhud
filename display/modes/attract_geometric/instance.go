...
func init() {
	displaymodes.RegisterFactory("attract_geometric", newInstance)
}

// instance implements displaymodes.ModeInstance for the geometric attract mode.
...
func (i *instance) ID() string { return "attract_geometric" }
